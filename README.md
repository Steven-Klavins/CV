...
| [Bank Tech Test](https://github.com/Steven-Klavins/bank-tech-test)            | A bank account application used via the command line, built following TDD.                                                                                          | Javascript, Jasmine                                                                      |   
| [Lost Horror](https://github.com/Steven-Klavins/losthorror.com)            | A custom WordPress theme built for a archive/blog documenting obscure horror films from the past.                                                                                          | PHP, WordPress, JavaScript, HTML, CSS, Twitter API, IMDB API                                                            | |
...
|----------------------|-------------------|---------------------|
| Amphora Research Systems | Software Developer | 02/2021 - Present   |
